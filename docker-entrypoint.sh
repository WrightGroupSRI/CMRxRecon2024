...
python3 /app/main.py --input_dir /input --predict_dir /output/E2ELR_TASK2 --weights_dir /app/weights/end_to_end.ckpt --recon_mode ours --challenge validation --task task2
