...
def main(args):
    wandb_logger = WandbLogger(project='cmrxrecon', log_model=True, name=args.run_name)
    ...
    model = LowRankLightning(cascades=1, unet_chans=4)
    trainer = pl.Trainer(
            default_root_dir='/home/kadotab/python/CMRxRecon2024/code/cmrxrecon/dl/models/model_weights/', 
            max_epochs=50, 
