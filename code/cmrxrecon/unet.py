...
class UnetLightning(pl.LightningModule):
    ...
    def validation_step(self, batch: tuple[torch.Tensor, torch.Tensor, torch.Tensor], batch_index: int): 
        ...
        ssim = calculate_ssim(fully_sampled, fs_estimate, self.device)
        nmse = calculate_nmse(fully_sampled, fs_estimate)
        psnr = calculate_psnr(fully_sampled, fs_estimate, self.device)
